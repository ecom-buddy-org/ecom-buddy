    ...
    <>
      ...
      <div className="mobile-section">
        <div className="mobile-sec-text" style={{ marginRight: "100px" }}>
          ...
          <br />
          <br />
          <p>With multiple keyword search options, like single-word and reverse ASIN searches, source everything from backend keywords to low-competition phrases, and more.</p>
          <p className="explore_link">
